        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-text-sub-light dark:text-text-sub-dark mt-2 text-sm">
              Browse community-created personal characters
            </p>
          </div>
          ...
          <div className="relative max-w-md mb-8">
            ...
            <input
              type="text"
              placeholder="Search custom characters..."
              value={searchQuery}
            ...
            <>
              ...
              {filteredCharacters.length === 0 && (
                <div className="text-center py-20 text-text-sub-light dark:text-text-sub-dark">
                  {searchQuery
                    ? `No custom characters found matching "${searchQuery}".`
                    : "No custom characters available yet."}
                </div>
              )}
            </>
          )}
